        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 max-w-xs">
              Providing high-quality products and exceptional service since 2015. Your one-stop shop for all your needs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                <svg className="h-5 w-5 mr-3 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span>support@shopplus.com</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex w-full md:w-auto">
              <input
                ...
                className="bg-gray-800 text-white px-4 py-3 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-full md:w-64"
              />
